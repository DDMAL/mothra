...
| CORS `*` defaults: backend env default, text-service unconditional | `landing-page/scripts/main.py:32`, `text-service/main.py:42`, `docker-compose.yml:74` | explicit origin allowlist, env-configured, no `*` default | open — row 27 |

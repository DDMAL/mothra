...
type View = 'landing' | 'about' | 'login' | 'register' | 'projects' | 'project' | 'models';
...
export interface ProjectModel { id: string; name: string; }
    ...
    return (
        <div className="min-h-screen flex flex-col">
            <Navbar
                ...
                loggedIn={view === 'projects' || view === 'project' || view === 'models'}

...
export default function AnnotationsTab({ annotations, projectId, section, usedNames, onUsedNamesChange }: AnnotationsTabProps) {
                  ...
                  {isUsed ? (
                    ...
                    <button
                      onClick={(e) => {
                        ...
                        onUsedNamesChange({
                          ...usedNames,
                          annotations: [...usedNames.annotations, set.imageName],
                        });
                      }}

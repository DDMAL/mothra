...
export default function TextAlignmentsTab({
    ...
    <>
      ...
      <div className="mt-6 grid grid-cols-5 gap-4">
        {textAlignments.map((set) => (
          <div key={set.id} className="flex flex-col gap-2 cursor-pointer" onClick={() => setViewSet(set)}>
            <div className="relative aspect-square">
              <div className="absolute inset-0 bg-[#C8E6E3]/50 rounded-xl overflow-hidden flex items-end justify-start p-2">
                ...
                <span className="relative text-[10px] text-white/80 font-mono z-10">.json</span>
                <button
